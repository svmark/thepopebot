...
Set up a comprehensive research assistant in the thepopebot codebase that will automatically generate financial market reports every weekday morning at 6 AM Pacific.
...
2. **Create RESEARCH_AGENT.md:**
   - Define the research agent's identity as a financial research specialist
...
5. **Update CRONS.json:**
   - Add new cron job entry:
     ...
     - Type: "agent"
     - Job: "Read operating_system/research_agent/RESEARCH_AGENT.md and generate today's financial market report. Update the file at operating_system/research_agent/financialreport.md with current market data, analysis, and insights using Brave Search."
     - Enabled: true
